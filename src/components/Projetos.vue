            ...
            <div class="p-6 md:p-8 lg:p-10">
              ...
              <div class="flex flex-col sm:flex-row gap-3 pt-6 border-t border-gray-200 dark:border-gray-700">
                <a :href="projetoSelecionado.github" target="_blank" 
                   class="flex-1 inline-flex items-center justify-center px-6 py-3.5 bg-gray-900 dark:bg-gray-700 text-white rounded-xl font-semibold hover:bg-gray-800 dark:hover:bg-gray-600 transition-all hover:shadow-lg hover:-translate-y-0.5" aria-label="GitHub" title="GitHub">
                  ...
                  <span class="sr-only">{{ t('verGithub') }}</span>
                </a>
              ...
              <div class="flex gap-3 mt-auto">
                <button @click="abrirModal(projeto)"
                 ...
                 <a :href="projeto.github" target="_blank" 
                   class="px-4 py-2 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg font-semibold hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors duration-200 text-sm" aria-label="GitHub" title="GitHub">
...
const projetos = computed(() => {
  ...
  return [
    ...
    },
    {
      ...
      link: '#',
      github: 'https://github.com/mglucena121/json-to-excel-api',
